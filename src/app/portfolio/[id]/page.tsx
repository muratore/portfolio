...
const Portfolio = () => {
  ...
  return (
    <div className="container flex flex-col justify-end w-full gap-10 m-auto pt-20">
      {/* Carregar as imagens do trabalho que está especificado */}
      <div className="flex flex-col h-full lg:w-[70%] md:pt-10 pl-4 m-auto">
        <h2 className="text-2xl md:text-3xl font-bold text-zinc-600 dark:text-zinc-100 mb-7 mt-5">
          {trabalhoSelecionado[0].cliente}
        </h2>
        <h3 className="mb-10 hidden md:block leading-8">{trabalhoSelecionado[0].descricao}</h3>
      </div>
      <div className="flex flex-col self-end w-[70%] gap-5 lg:w-[70%] m-auto ">
